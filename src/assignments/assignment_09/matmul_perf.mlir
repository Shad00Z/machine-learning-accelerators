module {
  ...
  aie.device(npu2) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0 to %ab step %c1 {
          ...
          // 16 K-iterations (1024 / 64): accumulate
    ...
    aie.runtime_sequence(%arg0: memref<256x1024xbf16>, %arg1: memref<1024x128xbf16>, %arg2: memref<256x128xbf16>) {
      ...
      // prologue: 5 tile-pairs in flight, ids in0 1-5 / in1 6-10
      ...
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 9 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 65536][8, 16, 16, 64][0, 64, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 10 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>

      // steady state: free one pair, issue next
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 81920][8, 16, 16, 64][0, 64, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 6 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 98304][8, 16, 16, 64][0, 64, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 7 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 114688][8, 16, 16, 64][0, 64, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 8 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 131072][8, 16, 16, 64][0, 64, 1024, 1]) {id = 4 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 9 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 147456][8, 16, 16, 64][0, 64, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 10 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 163840][8, 16, 16, 64][0, 64, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 6 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 180224][8, 16, 16, 64][0, 64, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 7 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 196608][8, 16, 16, 64][0, 64, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 8 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 212992][8, 16, 16, 64][0, 64, 1024, 1]) {id = 4 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 9 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 229376][8, 16, 16, 64][0, 64, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 10 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 245760][8, 16, 16, 64][0, 64, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @in0_L3L2_0} : memref<256x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 16, 64, 16][16, 8192, 128, 1]) {id = 6 : i64, issue_token = true, metadata = @in1_L3L2_0} : memref<1024x128xbf16>

      // epilogue: drain 5 in-flight pairs, then output
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
      aiex.npu.dma_wait {symbol = @in0_L3L2_0}
      aiex.npu.dma_wait {symbol = @in1_L3L2_0}
